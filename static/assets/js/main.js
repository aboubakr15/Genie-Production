(function () {
  ...
  function toggleTheme() {
    ...
    console.log('Theme switcher FIXED ✅');
  }
  ...
  function updateThemeButton(theme) {
    ...
    if (themeBtn) {
      ...
      if (theme === 'bright') {
        ...
        if (text) text.textContent = 'Bright';
      }
    }
  }

  // Robust attachThemeToggle with automatic retry
  let themeToggleAttached = false;
  function attachThemeToggle() {
    // Prevent duplicate listeners
    if (themeToggleAttached) return;
    ...
    if (themeToggleBtn) {
      ...
      // Retry after 500ms if button doesn't exist yet
